...
pub fn bundled_preset_to_json(controls: &HashMap<String, ControlValue>) -> serde_json::Value {
    serde_json::Value::Object(controls_to_json(controls))
}

pub fn user_preset_matches_controls(
...
pub fn bundled_preset_matches_controls(
    current_values: &HashMap<String, ControlValue>,
