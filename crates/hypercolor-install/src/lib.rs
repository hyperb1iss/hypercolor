...
pub use linux::{
    ...
    observe_linux_installation, parse_systemd_show, plan_linux_launch, prepare_linux_launch_roots,
    record_linux_launcher_settled, retain_linux_unit, run_linux_install, run_linux_recovery,
    run_linux_uninstall,
};
pub use model::{
