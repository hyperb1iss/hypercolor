...
pub struct SourceDiagnosticsDisplayField {
    #[cfg_attr(feature = "schema", schema(min_length = 1, max_length = 64))]
    pub key: String,
    #[cfg_attr(feature = "schema", schema(min_length = 1, max_length = 64))]
    pub label: String,
    #[cfg_attr(feature = "schema", schema(max_length = 256))]
    pub value: String,
}
...
pub struct SourceDiagnosticsEnvelope {
    #[cfg_attr(feature = "schema", schema(min_length = 1, max_length = 64))]
    schema: String,
    #[cfg_attr(feature = "schema", schema(minimum = 1, maximum = 255))]
    version: u16,
    #[cfg_attr(feature = "schema", schema(max_items = 24))]
