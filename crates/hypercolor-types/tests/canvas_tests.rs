//! Tests for the canvas surface, its pooling, and the canvas-facing re-export
//! of the color kernel.
//!
...
use hypercolor_types::canvas::{
    BYTES_PER_PIXEL, Canvas, Color, ColorFormat, DEFAULT_CANVAS_HEIGHT, DEFAULT_CANVAS_WIDTH,
