...
#[openapi(
    ...
    components(
        schemas(
            ...
            devices::SegmentTopologySummary,
            hypercolor_types::api::envelope::PageInfo,
...
pub const ROUTES: &[RouteSpec] = &[
    ...
    RouteSpec::post(
        "/api/v1/devices/{id}/segments/{segment}/identify",
        "identify_segment",
        "devices",
        "Identify one device segment",
    ),
    RouteSpec::post(
        "/api/v1/devices/{id}/attachments/{slot}/identify",
        "identify_attachment",
        "devices",
