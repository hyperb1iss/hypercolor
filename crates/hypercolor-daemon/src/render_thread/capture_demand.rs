...
impl CaptureDemand {
    ...
    pub(super) const fn is_active(self, domain: CaptureDomain) -> bool {
        match domain {
...
mod tests {
    ...
    fn failed_demand_retries_every_tick_and_paces_only_the_warning() {
        ...
        let demand = CaptureDemand::new(false, ScreenCaptureDemand::active(), false);
    ...
    fn graph_swap_cannot_interleave_between_capture_domains_or_stamp_them_current() {
        ...
        let demand = CaptureDemand::new(true, ScreenCaptureDemand::active(), true);
