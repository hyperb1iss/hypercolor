...
use hypercolor_core::input::screen::{
    ...
    ScreenCaptureBackend, ScreenCursorPolicy, ScreenNativeExecutionTarget,
    ...
    ScreenPublicationKind, ScreenReductionFilter, ScreenResourceApi,
};
...
use super::{NEXT_GPU_TEXTURE_STORAGE_ID, NEXT_SCREEN_TARGET_ID};
...
#[cfg(target_os = "windows")]
pub(super) fn create_screen_bridge(
    device: &wgpu::Device,
    queue: &wgpu::Queue,
