...
fn can_reuse_published_frame_for_deferred_sampling(
    render_stage: &super::frame_composer::RenderStageStats,
...
fn try_finish_deferred_zone_sampling(
...
) -> Option<super::sparkleflinger::PendingZoneSampling> {
...
fn discard_zone_sampling_backlog(render: &mut super::pipeline_runtime::RenderCaches) {
...
pub(crate) async fn execute_frame(
...

    {
        ...
        performance.record_frame(LatestFrameMetrics {
            ...
            producer_preview_compose_us: render_stage.producer_preview_compose_us,
            composition_us: render_stage.composition_us,
            render_us,
            sample_us,
            push_us,
