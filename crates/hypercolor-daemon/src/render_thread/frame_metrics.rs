...
pub(crate) struct ActiveFrameMetricsInput<'a> {
    ...
    pub(crate) preview_advance_us: u32,
    pub(crate) sample_us: u32,
    pub(crate) sample_dispatch_us: u32,
...
pub(crate) fn build_active_frame_metrics(input: ActiveFrameMetricsInput<'_>) -> LatestFrameMetrics {
    ...
    LatestFrameMetrics {
        ...
        scene_pool_free_slots: render_surfaces.scene_pool_free_slots,
        scene_pool_published_slots: render_surfaces.scene_pool_published_slots,
        scene_pool_dequeued_slots: render_surfaces.scene_pool_dequeued_slots,
        direct_pool_free_slots: render_surfaces.direct_pool_free_slots,
        direct_pool_published_slots: render_surfaces.direct_pool_published_slots,
        direct_pool_dequeued_slots: render_surfaces.direct_pool_dequeued_slots,
        preview_pool_slot_count: render_surfaces.preview_pool_slot_count,
        preview_pool_free_slots: render_surfaces.preview_pool_free_slots,
        preview_pool_published_slots: render_surfaces.preview_pool_published_slots,
        preview_pool_dequeued_slots: render_surfaces.preview_pool_dequeued_slots,
        compositor_pool_slot_count: render_surfaces.compositor_pool_slot_count,
        compositor_pool_free_slots: render_surfaces.compositor_pool_free_slots,
        compositor_pool_published_slots: render_surfaces.compositor_pool_published_slots,
        compositor_pool_dequeued_slots: render_surfaces.compositor_pool_dequeued_slots,
...
pub(crate) fn build_throttle_frame_metrics(
    ...
    LatestFrameMetrics {
        ...
        composition_us: 0,
        render_us: 0,
        preview_advance_us: 0,
        sample_us,
        sample_dispatch_us: 0,
        push_us,
        postprocess_us: 0,
        publish_us: publish_stats.elapsed_us,
        publish_frame_data_us: publish_stats.frame_data_us,
...
mod tests {
    ...
    fn active_frame_summary_derives_admission_from_metrics() {
        let summary = summarize_active_frame(ActiveFrameMetricsInput {
            ...
            render_us: 300,
            preview_advance_us: 35,
            sample_us: 40,
            sample_dispatch_us: 18,
            push_us: 25,
            postprocess_us: 15,
            total_us: 640,
            wake_late_us: 11,
