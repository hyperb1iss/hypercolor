...
use hypercolor_types::overlay::{
    Anchor, DisplayOverlayConfig, ImageFit, ImageOverlayConfig, OverlayBlendMode, OverlayPosition,
    OverlaySlot, OverlaySlotId, OverlaySource, TextAlign, TextOverlayConfig,
};
