use super::super::ScreenComputeCapacityPolicy;
#[cfg(feature = "macos-capture-fixtures")]
use super::super::{Arc, CpuReductionExecutor};
use super::super::{
    ...
    ScreenResourceApi, ScreenSourceReflection, ScreenSourceSelector, SourceScale, anyhow,
};
