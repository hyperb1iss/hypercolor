...
T = TypeVar("T", bound="ApiResponseEffectDetailResponseDataActiveControlValuesType0")


@_attrs_define
class ApiResponseEffectDetailResponseDataActiveControlValuesType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        api_response_effect_detail_response_data_active_control_values_type_0 = cls()
        ...
        api_response_effect_detail_response_data_active_control_values_type_0.additional_properties = additional_properties
        return api_response_effect_detail_response_data_active_control_values_type_0
