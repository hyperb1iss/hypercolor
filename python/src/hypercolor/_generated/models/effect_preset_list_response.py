...
if TYPE_CHECKING:
    from ..models.effect_preset import EffectPreset
    from ..models.page_info import PageInfo


T = TypeVar("T", bound="EffectPresetListResponse")


@_attrs_define
class EffectPresetListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = EffectPreset.from_dict(items_item_data)
        ...
        effect_preset_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        effect_preset_list_response.additional_properties = d
        return effect_preset_list_response
