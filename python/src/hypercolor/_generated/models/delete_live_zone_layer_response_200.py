...
T = TypeVar("T", bound="DeleteLiveZoneLayerResponse200")


@_attrs_define
class DeleteLiveZoneLayerResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_live_zone_layer_response_200 = cls(
            data=data,
            meta=meta,
        )

        delete_live_zone_layer_response_200.additional_properties = d
        return delete_live_zone_layer_response_200
