...
T = TypeVar("T", bound="SimulatedDisplayConfig")


@_attrs_define
class SimulatedDisplayConfig:
    """
    Attributes:
        height (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        simulated_display_config.additional_properties = d
        return simulated_display_config
