...
T = TypeVar("T", bound="PatchDisplayFaceControlsResponse200")


@_attrs_define
class PatchDisplayFaceControlsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_display_face_controls_response_200 = cls(
            data=data,
            meta=meta,
        )

        patch_display_face_controls_response_200.additional_properties = d
        return patch_display_face_controls_response_200
