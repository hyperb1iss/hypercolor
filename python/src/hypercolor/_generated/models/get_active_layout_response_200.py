...
T = TypeVar("T", bound="GetActiveLayoutResponse200")


@_attrs_define
class GetActiveLayoutResponse200:
    """
    Attributes:
        data (SpatialLayout): Top-level spatial layout container.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = SpatialLayout.from_dict(d.pop("data"))

        meta = ResponseMeta.from_dict(d.pop("meta"))

        get_active_layout_response_200 = cls(
            data=data,
            meta=meta,
        )

        get_active_layout_response_200.additional_properties = d
        return get_active_layout_response_200
