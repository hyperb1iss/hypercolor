...
T = TypeVar("T", bound="DeactivateSceneResponse200")


@_attrs_define
class DeactivateSceneResponse200:
    """
    Attributes:
        data (SceneDocument): The `GET /scene` document: the full live tree.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = SceneDocument.from_dict(d.pop("data"))

        meta = ResponseMeta.from_dict(d.pop("meta"))

        deactivate_scene_response_200 = cls(
            data=data,
            meta=meta,
        )

        deactivate_scene_response_200.additional_properties = d
        return deactivate_scene_response_200
