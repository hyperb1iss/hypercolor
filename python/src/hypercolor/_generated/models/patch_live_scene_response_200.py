...
T = TypeVar("T", bound="PatchLiveSceneResponse200")


@_attrs_define
class PatchLiveSceneResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_live_scene_response_200 = cls(
            data=data,
            meta=meta,
        )

        patch_live_scene_response_200.additional_properties = d
        return patch_live_scene_response_200
