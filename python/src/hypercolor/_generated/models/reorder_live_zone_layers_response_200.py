...
T = TypeVar("T", bound="ReorderLiveZoneLayersResponse200")


@_attrs_define
class ReorderLiveZoneLayersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reorder_live_zone_layers_response_200 = cls(
            data=data,
            meta=meta,
        )

        reorder_live_zone_layers_response_200.additional_properties = d
        return reorder_live_zone_layers_response_200
