...
if TYPE_CHECKING:
    from ..models.api_response_apply_effect_response_data_applied_controls import (
...
T = TypeVar("T", bound="ApiResponseApplyEffectResponseData")
...
class ApiResponseApplyEffectResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        applied_controls = ApiResponseApplyEffectResponseDataAppliedControls.from_dict(
        ...
        return api_response_apply_effect_response_data
