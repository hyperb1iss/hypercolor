...
T = TypeVar("T", bound="SceneLayoutActivationOutcome")


@_attrs_define
class SceneLayoutActivationOutcome:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scene_layout_activation_outcome = cls(
            applied=applied,
            layout_id=layout_id,
            message=message,
        )

        scene_layout_activation_outcome.additional_properties = d
        return scene_layout_activation_outcome
