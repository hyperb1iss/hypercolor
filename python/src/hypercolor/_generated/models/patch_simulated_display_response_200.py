...
T = TypeVar("T", bound="PatchSimulatedDisplayResponse200")


@_attrs_define
class PatchSimulatedDisplayResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_simulated_display_response_200 = cls(
            data=data,
            meta=meta,
        )

        patch_simulated_display_response_200.additional_properties = d
        return patch_simulated_display_response_200
