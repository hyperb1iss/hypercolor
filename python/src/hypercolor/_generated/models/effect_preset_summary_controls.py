...
T = TypeVar("T", bound="EffectPresetSummaryControls")


@_attrs_define
class EffectPresetSummaryControls:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        effect_preset_summary_controls = cls()
        ...
        effect_preset_summary_controls.additional_properties = additional_properties
        return effect_preset_summary_controls
