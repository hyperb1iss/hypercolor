...
T = TypeVar("T", bound="ConfigKeySchemaEntry")


@_attrs_define
class ConfigKeySchemaEntry:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_key_schema_entry.additional_properties = d
        return config_key_schema_entry
