...
if TYPE_CHECKING:
    from ..models.effect_playlist import EffectPlaylist
    from ..models.page_info import PageInfo


T = TypeVar("T", bound="EffectPlaylistListResponse")


@_attrs_define
class EffectPlaylistListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = EffectPlaylist.from_dict(items_item_data)
        ...
        effect_playlist_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        effect_playlist_list_response.additional_properties = d
        return effect_playlist_list_response
