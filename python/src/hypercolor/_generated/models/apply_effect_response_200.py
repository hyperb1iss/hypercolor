...
T = TypeVar("T", bound="ApplyEffectResponse200")


@_attrs_define
class ApplyEffectResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        apply_effect_response_200 = cls(
            data=data,
            meta=meta,
        )

        apply_effect_response_200.additional_properties = d
        return apply_effect_response_200
