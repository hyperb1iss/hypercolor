...
T = TypeVar("T", bound="MediaAuthorizationResponse")
...
class MediaAuthorizationResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        media_authorization_response = cls(
            adapter=adapter,
            authorized=authorized,
        )

        media_authorization_response.additional_properties = d
        return media_authorization_response
