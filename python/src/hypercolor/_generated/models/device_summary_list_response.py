...
T = TypeVar("T", bound="DeviceSummaryListResponse")


@_attrs_define
class DeviceSummaryListResponse:
    ...
    exist. `page: Some` means the endpoint genuinely pages.
        ...
        Attributes:
            items (list[DeviceSummary]): The items.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        device_summary_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        device_summary_list_response.additional_properties = d
        return device_summary_list_response
