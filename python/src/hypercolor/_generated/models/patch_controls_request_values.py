...
T = TypeVar("T", bound="PatchControlsRequestValues")


@_attrs_define
class PatchControlsRequestValues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        patch_controls_request_values = cls()
        ...
        patch_controls_request_values.additional_properties = additional_properties
        return patch_controls_request_values
