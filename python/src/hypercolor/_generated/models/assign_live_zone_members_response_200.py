...
T = TypeVar("T", bound="AssignLiveZoneMembersResponse200")


@_attrs_define
class AssignLiveZoneMembersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_live_zone_members_response_200 = cls(
            data=data,
            meta=meta,
        )

        assign_live_zone_members_response_200.additional_properties = d
        return assign_live_zone_members_response_200
