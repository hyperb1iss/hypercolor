...
T = TypeVar("T", bound="UnassignLiveZoneMemberResponse200")


@_attrs_define
class UnassignLiveZoneMemberResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unassign_live_zone_member_response_200 = cls(
            data=data,
            meta=meta,
        )

        unassign_live_zone_member_response_200.additional_properties = d
        return unassign_live_zone_member_response_200
