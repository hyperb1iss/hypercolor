...
if TYPE_CHECKING:
    ...
    from ..models.unclaimed_device import UnclaimedDevice


T = TypeVar("T", bound="UnclaimedDeviceListResponse")


@_attrs_define
class UnclaimedDeviceListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = UnclaimedDevice.from_dict(items_item_data)
        ...
        unclaimed_device_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        unclaimed_device_list_response.additional_properties = d
        return unclaimed_device_list_response
