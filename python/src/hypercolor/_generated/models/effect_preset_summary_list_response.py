...
T = TypeVar("T", bound="EffectPresetSummaryListResponse")


@_attrs_define
class EffectPresetSummaryListResponse:
    ...
    exist. `page: Some` means the endpoint genuinely pages.
        ...
        Attributes:
            items (list[EffectPresetSummary]): The items.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effect_preset_summary_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        effect_preset_summary_list_response.additional_properties = d
        return effect_preset_summary_list_response
