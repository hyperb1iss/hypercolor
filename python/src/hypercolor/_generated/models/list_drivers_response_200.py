...
T = TypeVar("T", bound="ListDriversResponse200")
...
class ListDriversResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_drivers_response_200 = cls(
            data=data,
            meta=meta,
        )

        list_drivers_response_200.additional_properties = d
        return list_drivers_response_200
