...
T = TypeVar("T", bound="DeviceCoverageRowListResponse")


@_attrs_define
class DeviceCoverageRowListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = DeviceCoverageRow.from_dict(items_item_data)
        ...
        device_coverage_row_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        device_coverage_row_list_response.additional_properties = d
        return device_coverage_row_list_response
