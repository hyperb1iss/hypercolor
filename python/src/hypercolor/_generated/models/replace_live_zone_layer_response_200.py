...
T = TypeVar("T", bound="ReplaceLiveZoneLayerResponse200")


@_attrs_define
class ReplaceLiveZoneLayerResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replace_live_zone_layer_response_200 = cls(
            data=data,
            meta=meta,
        )

        replace_live_zone_layer_response_200.additional_properties = d
        return replace_live_zone_layer_response_200
