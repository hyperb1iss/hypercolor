...
T = TypeVar("T", bound="PatchConfigKeyResponse200")


@_attrs_define
class PatchConfigKeyResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_config_key_response_200 = cls(
            data=data,
            meta=meta,
        )

        patch_config_key_response_200.additional_properties = d
        return patch_config_key_response_200
