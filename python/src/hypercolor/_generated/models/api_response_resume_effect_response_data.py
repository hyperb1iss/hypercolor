...
T = TypeVar("T", bound="ApiResponseResumeEffectResponseData")


@_attrs_define
class ApiResponseResumeEffectResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_response_resume_effect_response_data = cls(
            resumed=resumed,
            effect=effect,
        )

        api_response_resume_effect_response_data.additional_properties = d
        return api_response_resume_effect_response_data
