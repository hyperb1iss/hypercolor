...
if TYPE_CHECKING:
    from ..models.effect_preset_list_response import EffectPresetListResponse
...
class ListPresetsResponse200:
    """
    Attributes:
        data (EffectPresetListResponse): Canonical list payload: honest pagination or none at all.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = EffectPresetListResponse.from_dict(d.pop("data"))
