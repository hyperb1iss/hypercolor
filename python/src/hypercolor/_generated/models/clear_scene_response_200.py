...
T = TypeVar("T", bound="ClearSceneResponse200")


@_attrs_define
class ClearSceneResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clear_scene_response_200 = cls(
            data=data,
            meta=meta,
        )

        clear_scene_response_200.additional_properties = d
        return clear_scene_response_200
