...
T = TypeVar("T", bound="ResetConfigResponse200")


@_attrs_define
class ResetConfigResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reset_config_response_200 = cls(
            data=data,
            meta=meta,
        )

        reset_config_response_200.additional_properties = d
        return reset_config_response_200
