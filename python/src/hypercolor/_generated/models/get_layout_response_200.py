...
T = TypeVar("T", bound="GetLayoutResponse200")


@_attrs_define
class GetLayoutResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_layout_response_200 = cls(
            data=data,
            meta=meta,
        )

        get_layout_response_200.additional_properties = d
        return get_layout_response_200
