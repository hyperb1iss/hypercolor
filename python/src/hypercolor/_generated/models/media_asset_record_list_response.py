...
T = TypeVar("T", bound="MediaAssetRecordListResponse")


@_attrs_define
class MediaAssetRecordListResponse:
    ...
    exist. `page: Some` means the endpoint genuinely pages.
        ...
        Attributes:
            items (list[MediaAssetRecord]): The items.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = MediaAssetRecord.from_dict(items_item_data)
        ...
        media_asset_record_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        media_asset_record_list_response.additional_properties = d
        return media_asset_record_list_response
