...
if TYPE_CHECKING:
    from ..models.media_asset_record_list_response import MediaAssetRecordListResponse
...
class ListAssetsResponse200:
    """
    Attributes:
        data (MediaAssetRecordListResponse): Canonical list payload: honest pagination or none at all.
    ...
    data: MediaAssetRecordListResponse
    meta: ResponseMeta
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.media_asset_record_list_response import (
            MediaAssetRecordListResponse,
        )
        from ..models.response_meta import ResponseMeta

        d = dict(src_dict)
        data = MediaAssetRecordListResponse.from_dict(d.pop("data"))
