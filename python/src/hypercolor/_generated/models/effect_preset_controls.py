...
T = TypeVar("T", bound="EffectPresetControls")


@_attrs_define
class EffectPresetControls:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effect_preset_controls.additional_properties = additional_properties
        return effect_preset_controls
