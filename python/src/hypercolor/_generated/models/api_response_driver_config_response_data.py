...
T = TypeVar("T", bound="ApiResponseDriverConfigResponseData")


@_attrs_define
class ApiResponseDriverConfigResponseData:
    """
    Attributes:
        config_key (str):
        configurable (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_response_driver_config_response_data = cls(
            config_key=config_key,
            configurable=configurable,
            current=current,
            driver_id=driver_id,
        ...
        api_response_driver_config_response_data.additional_properties = d
        return api_response_driver_config_response_data
