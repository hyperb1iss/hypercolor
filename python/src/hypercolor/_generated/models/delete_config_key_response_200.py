...
T = TypeVar("T", bound="DeleteConfigKeyResponse200")
...
class DeleteConfigKeyResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_config_key_response_200 = cls(
            data=data,
            meta=meta,
        )

        delete_config_key_response_200.additional_properties = d
        return delete_config_key_response_200
