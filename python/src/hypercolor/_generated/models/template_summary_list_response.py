...
T = TypeVar("T", bound="TemplateSummaryListResponse")


@_attrs_define
class TemplateSummaryListResponse:
    ...
    exist. `page: Some` means the endpoint genuinely pages.
        ...
        Attributes:
            items (list[TemplateSummary]): The items.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = TemplateSummary.from_dict(items_item_data)
        ...
        template_summary_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        template_summary_list_response.additional_properties = d
        return template_summary_list_response
