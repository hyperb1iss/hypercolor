...
T = TypeVar("T", bound="GetAssetResponse200")


@_attrs_define
class GetAssetResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_asset_response_200 = cls(
            data=data,
            meta=meta,
        )

        get_asset_response_200.additional_properties = d
        return get_asset_response_200
