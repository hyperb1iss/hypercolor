...
T = TypeVar("T", bound="GetLiveZoneResponse200")


@_attrs_define
class GetLiveZoneResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_live_zone_response_200 = cls(
            data=data,
            meta=meta,
        )

        get_live_zone_response_200.additional_properties = d
        return get_live_zone_response_200
