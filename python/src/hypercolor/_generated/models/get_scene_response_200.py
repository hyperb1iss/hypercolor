...
T = TypeVar("T", bound="GetSceneResponse200")


@_attrs_define
class GetSceneResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_scene_response_200 = cls(
            data=data,
            meta=meta,
        )

        get_scene_response_200.additional_properties = d
        return get_scene_response_200
