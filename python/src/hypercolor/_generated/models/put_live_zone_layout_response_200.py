...
T = TypeVar("T", bound="PutLiveZoneLayoutResponse200")


@_attrs_define
class PutLiveZoneLayoutResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_live_zone_layout_response_200 = cls(
            data=data,
            meta=meta,
        )

        put_live_zone_layout_response_200.additional_properties = d
        return put_live_zone_layout_response_200
