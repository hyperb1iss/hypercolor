...
T = TypeVar("T", bound="ShowConfigResponse200")


@_attrs_define
class ShowConfigResponse200:
    """
    Attributes:
        data (ConfigDocument): Effective daemon config returned by `GET /api/v1/config`.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ConfigDocument.from_dict(d.pop("data"))

        meta = ResponseMeta.from_dict(d.pop("meta"))

        show_config_response_200 = cls(
            data=data,
            meta=meta,
        )

        show_config_response_200.additional_properties = d
        return show_config_response_200
