...
T = TypeVar("T", bound="CreateLiveZoneLayerResponse201")


@_attrs_define
class CreateLiveZoneLayerResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_live_zone_layer_response_201 = cls(
            data=data,
            meta=meta,
        )

        create_live_zone_layer_response_201.additional_properties = d
        return create_live_zone_layer_response_201
