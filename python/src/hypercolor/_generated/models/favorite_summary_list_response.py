...
T = TypeVar("T", bound="FavoriteSummaryListResponse")


@_attrs_define
class FavoriteSummaryListResponse:
    ...
    exist. `page: Some` means the endpoint genuinely pages.
        ...
        Attributes:
            items (list[FavoriteSummary]): The items.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = FavoriteSummary.from_dict(items_item_data)
        ...
        favorite_summary_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        favorite_summary_list_response.additional_properties = d
        return favorite_summary_list_response
