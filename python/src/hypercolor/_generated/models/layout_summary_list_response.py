...
if TYPE_CHECKING:
    from ..models.layout_summary import LayoutSummary
    from ..models.page_info import PageInfo


T = TypeVar("T", bound="LayoutSummaryListResponse")


@_attrs_define
class LayoutSummaryListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = LayoutSummary.from_dict(items_item_data)
        ...
        layout_summary_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        layout_summary_list_response.additional_properties = d
        return layout_summary_list_response
