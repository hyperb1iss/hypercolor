...
if TYPE_CHECKING:
    from ..models.api_response_control_surface_document_data_values import (
...
T = TypeVar("T", bound="ApiResponseControlSurfaceDocumentData")


@_attrs_define
class ApiResponseControlSurfaceDocumentData:
    ...
    Attributes:
        ...
        surface_id (str):
        values (ApiResponseControlSurfaceDocumentDataValues): Current field values keyed by field ID.
    ...
    surface_id: str
    values: ApiResponseControlSurfaceDocumentDataValues
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        values = ApiResponseControlSurfaceDocumentDataValues.from_dict(d.pop("values"))
        ...
        api_response_control_surface_document_data = cls(
            actions=actions,
            availability=availability,
            fields=fields,
            groups=groups,
        ...
        api_response_control_surface_document_data.additional_properties = d
        return api_response_control_surface_document_data
