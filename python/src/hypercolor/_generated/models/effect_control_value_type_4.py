...
T = TypeVar("T", bound="EffectControlValueType4")


@_attrs_define
class EffectControlValueType4:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        effect_control_value_type_4 = cls(
            gradient=gradient,
        )

        effect_control_value_type_4.additional_properties = d
        return effect_control_value_type_4
