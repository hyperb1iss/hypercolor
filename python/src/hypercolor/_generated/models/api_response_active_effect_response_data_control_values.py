...
T = TypeVar("T", bound="ApiResponseActiveEffectResponseDataControlValues")


@_attrs_define
class ApiResponseActiveEffectResponseDataControlValues:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        api_response_active_effect_response_data_control_values = cls()
        ...
        api_response_active_effect_response_data_control_values.additional_properties = additional_properties
        return api_response_active_effect_response_data_control_values
