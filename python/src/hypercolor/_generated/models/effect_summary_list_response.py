...
if TYPE_CHECKING:
    from ..models.effect_summary import EffectSummary
    from ..models.page_info import PageInfo


T = TypeVar("T", bound="EffectSummaryListResponse")


@_attrs_define
class EffectSummaryListResponse:
    ...
    exist. `page: Some` means the endpoint genuinely pages.
        ...
        Attributes:
            items (list[EffectSummary]): The items.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = EffectSummary.from_dict(items_item_data)
        ...
        effect_summary_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        effect_summary_list_response.additional_properties = d
        return effect_summary_list_response
