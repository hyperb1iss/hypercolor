...
T = TypeVar("T", bound="DeviceComponentsUpdateResponse")


@_attrs_define
class DeviceComponentsUpdateResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        needs_layout_update = self.needs_layout_update
        ...
        field_dict.update(
            {
                ...
                "needs_layout_update": needs_layout_update,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        needs_layout_update = d.pop("needs_layout_update")
        ...
        device_components_update_response = cls(
            device_id=device_id,
            device_name=device_name,
            needs_layout_update=needs_layout_update,
            bindings=bindings,
        ...
        device_components_update_response.additional_properties = d
        return device_components_update_response
