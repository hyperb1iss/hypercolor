...
T = TypeVar("T", bound="SceneSummaryListResponse")


@_attrs_define
class SceneSummaryListResponse:
    ...
    exist. `page: Some` means the endpoint genuinely pages.
        ...
        Attributes:
            items (list[SceneSummary]): The items.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = SceneSummary.from_dict(items_item_data)
        ...
        scene_summary_list_response = cls(
            items=items,
            total=total,
            page=page,
        )

        scene_summary_list_response.additional_properties = d
        return scene_summary_list_response
