...
from ...models.get_sensors_response_200 import GetSensorsResponse200
...
) -> ApiErrorBody | GetSensorsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSensorsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetSensorsResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | GetSensorsResponse200
    """
