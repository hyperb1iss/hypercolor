...
from ...models.list_audio_devices_response_200 import ListAudioDevicesResponse200
...
) -> ApiErrorBody | ListAudioDevicesResponse200 | None:
    if response.status_code == 200:
        response_200 = ListAudioDevicesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ListAudioDevicesResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ListAudioDevicesResponse200
    """
