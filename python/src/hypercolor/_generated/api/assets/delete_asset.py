...
from ...models.delete_asset_response_200 import DeleteAssetResponse200
...
) -> ApiErrorBody | DeleteAssetResponse200 | None:
    if response.status_code == 200:
        response_200 = DeleteAssetResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | DeleteAssetResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | DeleteAssetResponse200
    """
