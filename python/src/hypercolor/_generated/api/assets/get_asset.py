...
from ...models.get_asset_response_200 import GetAssetResponse200
...
) -> ApiErrorBody | GetAssetResponse200 | None:
    if response.status_code == 200:
        response_200 = GetAssetResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetAssetResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetAssetResponse200
    """
