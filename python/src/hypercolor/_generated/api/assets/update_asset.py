...
from ...models.update_asset_response_200 import UpdateAssetResponse200
...
) -> ApiErrorBody | UpdateAssetResponse200 | None:
    if response.status_code == 200:
        response_200 = UpdateAssetResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | UpdateAssetResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (AssetUpdateRequest): Request body for `PUT /api/v1/assets/{id}`.
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | UpdateAssetResponse200
    """
