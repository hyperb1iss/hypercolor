...
from ...models.delete_scene_response_200 import DeleteSceneResponse200
...
) -> ApiErrorBody | DeleteSceneResponse200 | None:
    if response.status_code == 200:
        response_200 = DeleteSceneResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | DeleteSceneResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | DeleteSceneResponse200
    """
