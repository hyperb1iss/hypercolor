...
from ...models.get_live_scene_response_200 import GetLiveSceneResponse200
...
) -> ApiErrorBody | GetLiveSceneResponse200 | None:
    if response.status_code == 200:
        response_200 = GetLiveSceneResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetLiveSceneResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | GetLiveSceneResponse200
    """
