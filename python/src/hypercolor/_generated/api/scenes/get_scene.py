...
from ...models.get_scene_response_200 import GetSceneResponse200
...
) -> ApiErrorBody | GetSceneResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSceneResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetSceneResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetSceneResponse200
    """
