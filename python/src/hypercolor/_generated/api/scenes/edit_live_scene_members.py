...
from ...models.edit_live_scene_members_response_200 import (
    EditLiveSceneMembersResponse200,
)
from ...models.edit_members_request import EditMembersRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = EditLiveSceneMembersResponse200.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | EditLiveSceneMembersResponse200
    """
