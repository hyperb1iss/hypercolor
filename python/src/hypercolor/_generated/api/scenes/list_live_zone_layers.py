...
from ...models.list_live_zone_layers_response_200 import ListLiveZoneLayersResponse200
...
) -> ApiErrorBody | ListLiveZoneLayersResponse200 | None:
    if response.status_code == 200:
        response_200 = ListLiveZoneLayersResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ListLiveZoneLayersResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | ListLiveZoneLayersResponse200
    """
