...
from ...models.create_scene_request import CreateSceneRequest
from ...models.create_scene_response_201 import CreateSceneResponse201
...
) -> ApiErrorBody | CreateSceneResponse201 | None:
    if response.status_code == 201:
        response_201 = CreateSceneResponse201.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | CreateSceneResponse201]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (CreateSceneRequest): Request body for `POST /api/v1/scenes`.
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | CreateSceneResponse201
    """
