...
from ...models.assign_live_zone_members_response_200 import (
    AssignLiveZoneMembersResponse200,
)
from ...models.assign_members_request import AssignMembersRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/scene/zones/{zone}/members".format(
...
) -> ApiErrorBody | AssignLiveZoneMembersResponse200 | None:
    if response.status_code == 200:
        response_200 = AssignLiveZoneMembersResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | AssignLiveZoneMembersResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        zone (str):
        body (AssignMembersRequest): `POST /scene/zones/{zone}/members` — assign device segments.
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | AssignLiveZoneMembersResponse200
    """
