...
from ...models.get_live_zone_response_200 import GetLiveZoneResponse200
...
) -> ApiErrorBody | GetLiveZoneResponse200 | None:
    if response.status_code == 200:
        response_200 = GetLiveZoneResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetLiveZoneResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetLiveZoneResponse200
    """
