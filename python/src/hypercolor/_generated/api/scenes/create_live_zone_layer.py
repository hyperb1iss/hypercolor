...
from ...models.create_live_zone_layer_response_201 import CreateLiveZoneLayerResponse201
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/scene/zones/{zone}/layers".format(
...
) -> ApiErrorBody | CreateLiveZoneLayerResponse201 | None:
    if response.status_code == 201:
        response_201 = CreateLiveZoneLayerResponse201.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | CreateLiveZoneLayerResponse201]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | CreateLiveZoneLayerResponse201
    """
