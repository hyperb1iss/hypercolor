...
from ...models.list_scenes_response_200 import ListScenesResponse200
...
) -> ApiErrorBody | ListScenesResponse200 | None:
    if response.status_code == 200:
        response_200 = ListScenesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ListScenesResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ListScenesResponse200
    """
