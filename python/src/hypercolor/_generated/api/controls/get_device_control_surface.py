...
from ...models.get_device_control_surface_response_200 import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/devices/{id}/controls".format(
...
) -> ApiErrorBody | GetDeviceControlSurfaceResponse200 | None:
    if response.status_code == 200:
        response_200 = GetDeviceControlSurfaceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetDeviceControlSurfaceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetDeviceControlSurfaceResponse200
    """
