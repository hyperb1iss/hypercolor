...
from ...models.invoke_control_surface_action_response_200 import (
...
) -> ApiErrorBody | InvokeControlSurfaceActionResponse200 | None:
    if response.status_code == 200:
        response_200 = InvokeControlSurfaceActionResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | InvokeControlSurfaceActionResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | InvokeControlSurfaceActionResponse200
    """
