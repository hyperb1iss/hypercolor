...
from ...models.get_control_surface_response_200 import GetControlSurfaceResponse200
...
) -> ApiErrorBody | GetControlSurfaceResponse200 | None:
    if response.status_code == 200:
        response_200 = GetControlSurfaceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetControlSurfaceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetControlSurfaceResponse200
    """
