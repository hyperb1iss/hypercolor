...
from ...models.get_driver_control_surface_response_200 import (
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/drivers/{id}/controls".format(
...
) -> ApiErrorBody | GetDriverControlSurfaceResponse200 | None:
    if response.status_code == 200:
        response_200 = GetDriverControlSurfaceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetDriverControlSurfaceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetDriverControlSurfaceResponse200
    """
