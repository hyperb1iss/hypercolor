...
from ...models.list_drivers_response_200 import ListDriversResponse200
...
) -> ApiErrorBody | ListDriversResponse200 | None:
    if response.status_code == 200:
        response_200 = ListDriversResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ListDriversResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ListDriversResponse200
    """
