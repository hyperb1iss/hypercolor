...
from ...models.get_driver_config_response_200 import GetDriverConfigResponse200
...
) -> ApiErrorBody | GetDriverConfigResponse200 | None:
    if response.status_code == 200:
        response_200 = GetDriverConfigResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetDriverConfigResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetDriverConfigResponse200
    """
