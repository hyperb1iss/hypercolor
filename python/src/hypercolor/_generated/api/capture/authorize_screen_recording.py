...
from ...models.authorize_screen_recording_response_200 import (
...
) -> ApiErrorBody | AuthorizeScreenRecordingResponse200 | None:
    if response.status_code == 200:
        response_200 = AuthorizeScreenRecordingResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | AuthorizeScreenRecordingResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | AuthorizeScreenRecordingResponse200
    """
