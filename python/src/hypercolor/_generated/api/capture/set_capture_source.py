...
from ...models.set_capture_source_response_200 import SetCaptureSourceResponse200
...
) -> ApiErrorBody | SetCaptureSourceResponse200 | None:
    if response.status_code == 200:
        response_200 = SetCaptureSourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | SetCaptureSourceResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | SetCaptureSourceResponse200
    """
