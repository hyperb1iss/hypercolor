...
from ...models.get_preset_response_200 import GetPresetResponse200
...
) -> ApiErrorBody | GetPresetResponse200 | None:
    if response.status_code == 200:
        response_200 = GetPresetResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetPresetResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetPresetResponse200
    """
