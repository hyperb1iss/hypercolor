...
from ...models.delete_preset_response_200 import DeletePresetResponse200
...
) -> ApiErrorBody | DeletePresetResponse200 | None:
    if response.status_code == 200:
        response_200 = DeletePresetResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | DeletePresetResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | DeletePresetResponse200
    """
