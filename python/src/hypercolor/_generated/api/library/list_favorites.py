...
from ...models.list_favorites_response_200 import ListFavoritesResponse200
...
) -> ApiErrorBody | ListFavoritesResponse200 | None:
    if response.status_code == 200:
        response_200 = ListFavoritesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ListFavoritesResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ListFavoritesResponse200
    """
