...
from ...models.deactivate_playlist_response_200 import DeactivatePlaylistResponse200
...
) -> ApiErrorBody | DeactivatePlaylistResponse200 | None:
    if response.status_code == 200:
        response_200 = DeactivatePlaylistResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | DeactivatePlaylistResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | DeactivatePlaylistResponse200
    """
