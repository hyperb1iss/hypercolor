...
from ...models.list_playlists_response_200 import ListPlaylistsResponse200
...
) -> ApiErrorBody | ListPlaylistsResponse200 | None:
    if response.status_code == 200:
        response_200 = ListPlaylistsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ListPlaylistsResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ListPlaylistsResponse200
    """
