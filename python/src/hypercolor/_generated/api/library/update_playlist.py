...
from ...models.save_playlist_request import SavePlaylistRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/library/playlists/{id}".format(
...
) -> ApiErrorBody | UpdatePlaylistResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | UpdatePlaylistResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (SavePlaylistRequest): Request body for `POST /api/v1/library/playlists` and
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | UpdatePlaylistResponse200
    """
