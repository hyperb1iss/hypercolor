...
from ...models.remove_favorite_response_200 import RemoveFavoriteResponse200
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/v1/library/favorites/{effect}".format(
            effect=quote(str(effect), safe=""),
        ),
    }
...
) -> ApiErrorBody | RemoveFavoriteResponse200 | None:
    if response.status_code == 200:
        response_200 = RemoveFavoriteResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | RemoveFavoriteResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | RemoveFavoriteResponse200
    """
