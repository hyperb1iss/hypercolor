...
) -> ApiErrorBody | CreatePlaylistResponse201 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | CreatePlaylistResponse201]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | CreatePlaylistResponse201
    """
