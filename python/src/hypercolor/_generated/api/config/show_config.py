...
from ...models.show_config_response_200 import ShowConfigResponse200
...
) -> ApiErrorBody | ShowConfigResponse200 | None:
    if response.status_code == 200:
        response_200 = ShowConfigResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ShowConfigResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ShowConfigResponse200
    """
