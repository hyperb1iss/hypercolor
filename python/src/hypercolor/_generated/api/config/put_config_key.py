...
from ...models.put_config_key_response_200 import PutConfigKeyResponse200
...
) -> ApiErrorBody | PutConfigKeyResponse200 | None:
    if response.status_code == 200:
        response_200 = PutConfigKeyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | PutConfigKeyResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | PutConfigKeyResponse200
    """
