...
from ...models.get_config_key_response_200 import GetConfigKeyResponse200
...
) -> ApiErrorBody | GetConfigKeyResponse200 | None:
    if response.status_code == 200:
        response_200 = GetConfigKeyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetConfigKeyResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetConfigKeyResponse200
    """
