...
from ...models.reset_config_response_200 import ResetConfigResponse200
...
) -> ApiErrorBody | ResetConfigResponse200 | None:
    if response.status_code == 200:
        response_200 = ResetConfigResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ResetConfigResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ResetConfigResponse200
    """
