...
from ...models.get_effect_response_200 import GetEffectResponse200
...
) -> ApiErrorBody | GetEffectResponse200 | None:
    if response.status_code == 200:
        response_200 = GetEffectResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetEffectResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetEffectResponse200
    """
