...
from ...models.rescan_effects_response_200 import RescanEffectsResponse200
...
) -> ApiErrorBody | RescanEffectsResponse200 | None:
    if response.status_code == 200:
        response_200 = RescanEffectsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | RescanEffectsResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | RescanEffectsResponse200
    """
