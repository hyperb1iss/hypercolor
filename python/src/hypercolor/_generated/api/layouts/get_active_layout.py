...
from ...models.get_active_layout_response_200 import GetActiveLayoutResponse200
...
) -> ApiErrorBody | GetActiveLayoutResponse200 | None:
    if response.status_code == 200:
        response_200 = GetActiveLayoutResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetActiveLayoutResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | GetActiveLayoutResponse200
    """
