...
from ...models.get_layout_response_200 import GetLayoutResponse200
...
) -> ApiErrorBody | GetLayoutResponse200 | None:
    if response.status_code == 200:
        response_200 = GetLayoutResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetLayoutResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetLayoutResponse200
    """
