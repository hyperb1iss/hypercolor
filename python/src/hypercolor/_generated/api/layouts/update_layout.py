...
from ...models.update_layout_request import UpdateLayoutRequest
from ...models.update_layout_response_200 import UpdateLayoutResponse200
...
) -> ApiErrorBody | UpdateLayoutResponse200 | None:
    if response.status_code == 200:
        response_200 = UpdateLayoutResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | UpdateLayoutResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (UpdateLayoutRequest): Request body for `PUT /api/v1/layouts/{id}`.
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | UpdateLayoutResponse200
    """
