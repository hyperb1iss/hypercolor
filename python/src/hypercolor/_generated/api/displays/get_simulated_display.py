...
from ...models.get_simulated_display_response_200 import GetSimulatedDisplayResponse200
...
) -> ApiErrorBody | GetSimulatedDisplayResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSimulatedDisplayResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetSimulatedDisplayResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetSimulatedDisplayResponse200
    """
