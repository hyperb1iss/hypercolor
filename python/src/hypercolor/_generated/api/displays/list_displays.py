...
from ...models.list_displays_response_200 import ListDisplaysResponse200
...
) -> ApiErrorBody | ListDisplaysResponse200 | None:
    if response.status_code == 200:
        response_200 = ListDisplaysResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | ListDisplaysResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | ListDisplaysResponse200
    """
