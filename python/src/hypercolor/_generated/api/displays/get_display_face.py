...
from ...models.get_display_face_response_200 import GetDisplayFaceResponse200
...
) -> ApiErrorBody | GetDisplayFaceResponse200 | None:
    if response.status_code == 200:
        response_200 = GetDisplayFaceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetDisplayFaceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetDisplayFaceResponse200
    """
