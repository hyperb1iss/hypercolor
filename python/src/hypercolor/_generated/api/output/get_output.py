...
from ...models.get_output_response_200 import GetOutputResponse200
...
) -> ApiErrorBody | GetOutputResponse200 | None:
    if response.status_code == 200:
        response_200 = GetOutputResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetOutputResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | GetOutputResponse200
    """
