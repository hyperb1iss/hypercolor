...
from ...models.diagnose_request import DiagnoseRequest
from ...models.run_diagnostics_response_200 import RunDiagnosticsResponse200
...
) -> ApiErrorBody | RunDiagnosticsResponse200 | None:
    if response.status_code == 200:
        response_200 = RunDiagnosticsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | RunDiagnosticsResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        body (DiagnoseRequest): Optional body for `POST /api/v1/diagnose`.
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | RunDiagnosticsResponse200
    """
