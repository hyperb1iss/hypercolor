...
from ...models.get_attachments_response_200 import GetAttachmentsResponse200
...
) -> ApiErrorBody | GetAttachmentsResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetAttachmentsResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | GetAttachmentsResponse200
    """
