...
from ...models.delete_pairing_response_200 import DeletePairingResponse200
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/v1/devices/{id}/pair".format(
...
) -> ApiErrorBody | DeletePairingResponse200 | None:
    if response.status_code == 200:
        response_200 = DeletePairingResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | DeletePairingResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | DeletePairingResponse200
    """
