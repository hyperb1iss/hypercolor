...
from ...models.identify_attachment_request import IdentifyAttachmentRequest
from ...models.identify_attachment_response_200 import IdentifyAttachmentResponse200
...
def _get_kwargs(
    ...
    slot: str,
    *,
    body: IdentifyAttachmentRequest | Unset = UNSET,
) -> dict[str, Any]:
...
) -> ApiErrorBody | IdentifyAttachmentResponse200 | None:
    if response.status_code == 200:
        response_200 = IdentifyAttachmentResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | IdentifyAttachmentResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        slot (str):
        body (IdentifyAttachmentRequest | Unset): Request body for
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | IdentifyAttachmentResponse200
    """
