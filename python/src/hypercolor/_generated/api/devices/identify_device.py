...
from ...models.identify_device_response_200 import IdentifyDeviceResponse200
...
def _get_kwargs(
    id: str,
    *,
    body: IdentifyRequest | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/devices/{id}/identify".format(
...
) -> ApiErrorBody | IdentifyDeviceResponse200 | None:
    if response.status_code == 200:
        response_200 = IdentifyDeviceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | IdentifyDeviceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | IdentifyDeviceResponse200
    """
