...
from ...models.identify_segment_response_200 import IdentifySegmentResponse200
...
) -> ApiErrorBody | IdentifySegmentResponse200 | None:
    if response.status_code == 200:
        response_200 = IdentifySegmentResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | IdentifySegmentResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | IdentifySegmentResponse200
    """
