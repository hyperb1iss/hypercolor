...
from ...models.pair_device_response_200 import PairDeviceResponse200
...
) -> ApiErrorBody | PairDeviceResponse200 | None:
    if response.status_code == 200:
        response_200 = PairDeviceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | PairDeviceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | PairDeviceResponse200
    """
