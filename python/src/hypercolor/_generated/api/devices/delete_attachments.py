...
from ...models.delete_attachments_response_200 import DeleteAttachmentsResponse200
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/v1/devices/{id}/attachments".format(
...
) -> ApiErrorBody | DeleteAttachmentsResponse200 | None:
    if response.status_code == 200:
        response_200 = DeleteAttachmentsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | DeleteAttachmentsResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | DeleteAttachmentsResponse200
    """
