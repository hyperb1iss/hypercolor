...
from ...models.delete_device_response_200 import DeleteDeviceResponse200
...
) -> ApiErrorBody | DeleteDeviceResponse200 | None:
    if response.status_code == 200:
        response_200 = DeleteDeviceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | DeleteDeviceResponse200]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | DeleteDeviceResponse200
    """
