...
from ...models.get_device_coverage_response_200 import GetDeviceCoverageResponse200
...
) -> ApiErrorBody | GetDeviceCoverageResponse200 | None:
    if response.status_code == 200:
        response_200 = GetDeviceCoverageResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | GetDeviceCoverageResponse200]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | GetDeviceCoverageResponse200
    """
