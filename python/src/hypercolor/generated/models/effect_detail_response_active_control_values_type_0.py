...
T = TypeVar("T", bound="EffectDetailResponseActiveControlValuesType0")


@_attrs_define
class EffectDetailResponseActiveControlValuesType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        effect_detail_response_active_control_values_type_0 = cls()
        ...
        effect_detail_response_active_control_values_type_0.additional_properties = (
            additional_properties
        )
        return effect_detail_response_active_control_values_type_0
