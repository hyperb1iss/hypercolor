...
```typescript
import { audio, canvas, combo, createPaletteFn, num, toggle } from '@hypercolor/sdk'
...
export default canvas(
    'Prism Choir',
    {
        ...
        palette: combo('Palette', ['SilkCircuit', 'Aurora', 'Synthwave'], { group: 'Color' }),
        petals: combo('Petals', ['6', '8', '12'], { default: '12', group: 'Shape' }),
    ...
    () => {
        ...
        return (ctx, time, controls) => {
            ...
            for (let i = 0; i < petalCount; i++) {
                ...
                const angle = (i / petalCount) * Math.PI * 2 + a.chordMood * 0.3 * Math.sin(i * 0.7)
    ...
    },
    {
        audio: true,
        author: 'You',
        description: 'Twelve petals of light, each bound to a chromatic pitch class',
    },
)
```
