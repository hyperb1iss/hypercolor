...
- [The pieces](@/guide/the-pieces.md): mental model of the daemon, app, tray, TUI, CLI, and web UI, and how they connect
...
- [Changelog](@/guide/changelog.md): versioning policy and where release notes live
...
**MCP server**: 18 tools, 5 resources, and 4 prompts for AI assistant integration (Claude Code, Cursor, and friends). The MCP server is **disabled by default**; see the [MCP server reference](@/api/mcp.md) for how to enable it and connect your agent.
