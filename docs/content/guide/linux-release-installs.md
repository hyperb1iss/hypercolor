...
without changing anything and names what it found. An interrupted uninstall continues where it stopped when you run it
again. The empty `~/.hypercolor-release-install.lock` bootstrap lock file is
