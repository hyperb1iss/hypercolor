...
| [HyperX](#hyperx) | — | — | 16 | — | — |
| [HYTE](#hyte) | — | — | 2 | — | — |
| [Lian Li](#lianli) | 13 | — | 2 | — | `lianli` |
| [Logitech](#logitech) | — | — | 9 | — | — |
| [Mountain](#mountain) | — | — | 4 | — | — |
| [MSI](#msi) | — | — | 11 | — | — |
| [Nanoleaf](#nanoleaf) | 1 | — | — | — | `nanoleaf` |
| [Nollie](#nollie) | 19 | — | — | — | `nollie` |
| [NZXT](#nzxt) | — | — | 17 | — | — |
| [Philips](#philips) | 1 | — | — | — | `hue` |
| [PrismRGB](#prismrgb) | 3 | — | — | — | `nollie`, `prismrgb` |
| [QMK](#qmk) | 10 | — | — | — | `qmk` |
...
- **`corsair`** — 49 supported devices
- **`nollie`** — 20 supported devices
- **`lianli`** — 13 supported devices
- **`qmk`** — 11 supported devices
- **`asus`** — 10 supported devices
- **`govee`** — 4 supported devices
- **`prismrgb`** — 2 supported devices
...
| Corsair | K60 Pro RGB Low Profile | 0x1BAD | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K60 Pro RGB SE | 0x1B8D | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K60 Pro TKL Black | 0x1BC7 | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K60 Pro TKL White | 0x1BED | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K65 Mini | 0x1BAF | Keyboard | `corsair` | USB HID | 123 | Bragi 1024-byte HID reports, per-key RGB |
| Corsair | K70 Core RGB | 0x2B0A | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K70 Core RGB | 0x1BFF | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K70 Core RGB | 0x1BFD | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K70 Core RGB TKL | 0x2B01 | Keyboard | `corsair` | USB HID | 102 | Bragi 64-byte HID reports, per-key RGB |
| Corsair | K70 Pro Optical | 0x1BD4 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| Corsair | K70 RGB Pro | 0x1BC4 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| Corsair | K70 RGB Pro V2 | 0x1BB3 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| Corsair | K70 TKL | 0x1B73 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| Corsair | K70 TKL Champion Optical | 0x1BB9 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| Corsair | K95 Platinum XT | 0x1B89 | Keyboard | `corsair` | USB HID | 156 | Bragi 64-byte HID reports, top-bar keyboard topology |
| Corsair | Katar Pro | 0x1B93 | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
| Corsair | Katar Pro V2 | 0x1BBA | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
| Corsair | Katar Pro XT | 0x1BAC | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
...
| Corsair | M55 RGB Pro | 0x1B70 | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
| Corsair | M65 RGB Ultra Wired | 0x1B9E | Mouse | `corsair` | USB HID | 3 | Bragi 64-byte HID reports |
| Corsair | M65 RGB Ultra Wireless (Wired) | 0x1BB5 | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
...
| Govee | Govee RGBIC Light Bars | — | Lightbar | `govee` | UDP | — | Govee Flow and Flow Pro desktop light bars and similar segmented RGBIC bars. |
| Govee | Govee RGBIC TV Backlight | — | LED strip | `govee` | UDP | — | Immersion and Envisual TV backlight kits. The backlight strip streams over the Govee LAN protocol; the bundled camera module is not used. |
| Lian Li | L-Wireless Controller | 0x8040 | Fan controller | `lianli` | USB bulk transfer | — | V1 2.4GHz TX (SLV3TX) paired with its 0x8041 RX sibling behind the controller's internal hub. Discovers bound TL/SL wireless fan clusters and streams per-LED RGB over RF; 26 LEDs per TL fan, up to 4 fans per cluster. |
...
| Lian Li | Uni Fan SL Wireless LCD | 0x1CBE:0x0005 | LCD module | `lianli` | USB bulk transfer | — | SL V3 wireless LCD receiver; same protocol as the TL receiver. |
| Lian Li | Uni Fan TL LCD | 0x04FC:0x7393 | LCD module | `lianli` | USB HID | — | 400x400 round panel. JPEG streaming in 512-byte packets; every unit reports serial TL_LCDV0.1, so identity keys on the USB port path. |
| Lian Li | Uni Fan TL Wireless LCD | 0x1CBE:0x0006 | LCD module | `lianli` | USB bulk transfer | — | One bulk receiver per wireless LCD fan over its 9-pin USB cable. 400x400 round panel; DES-wrapped 512-byte headers and a fixed 102400-byte frame write (101888 bytes of JPEG). |
...
| Nollie | Nollie 1 | 0x1F11 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2 and NOS2 VID 0x16D5, 1 channel x 630 LEDs, GRB byte order |
| Nollie | Nollie 1 CDC | 0x2A01 | ARGB controller | `nollie` | USB serial | — | VID 0x16D5, 115200 8N1 CDC transport |
| Nollie | Nollie 16 #1 legacy / v1.2 | 0x1613 | ARGB controller | `nollie` | USB HID | — | VID 0x16D1 legacy 8x100 and VID 0x16D2 v1.2 channels 01-08 |
| Nollie | Nollie 16 #2 legacy / v1.2 | 0x1615 | ARGB controller | `nollie` | USB HID | — | VID 0x16D1 legacy 8x100 and VID 0x16D2 v1.2 channels 09-16 |
| Nollie | Nollie 16 v3 | 0x4716 | ARGB controller | `nollie` | USB HID | — | VID 0x3061 grouped Gen-2 HID; VID 0x16D5 NOS2 single-channel 1024-byte HID |
| Nollie | Nollie 16 v3 NOS2 | 0x2A16 | ARGB controller | `nollie` | USB HID | — | VID 0x16D5 alternate PID, NOS2 single-channel 1024-byte HID |
| Nollie | Nollie 2 | 0x1619 | ARGB controller | `nollie` | USB HID | — | VID 0x16D1, 2 channels x 512 LEDs, legacy 20-LED packet header |
| Nollie | Nollie 28/12 v1.2 | 0x1616 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie | Nollie 32 | 0x4714 | ARGB controller | `nollie` | USB HID | — | VID 0x3061 grouped Gen-2 HID; VID 0x16D5 NOS2 HID; supports ATX/GPU Strimer rows |
| Nollie | Nollie 32 NOS2 | 0x2A32 | ARGB controller | `nollie` | USB HID | — | VID 0x16D5 alternate PID, NOS2 single-channel 1024-byte HID |
| Nollie | Nollie 4 | 0x4711 | ARGB controller | `nollie` | USB HID | — | VID 0x3061, interface 3, 4 channels x 636 LEDs |
| Nollie | Nollie 8 CDC | 0x2A08 | ARGB controller | `nollie` | USB serial | — | VID 0x16D5, 115200 8N1 CDC transport |
| Nollie | Nollie 8 legacy / Nollie 8 v1.2 | 0x1612 | ARGB controller | `nollie` | USB HID | — | VID 0x16D1 legacy 8x100 and VID 0x16D2 v1.2 8x525 are both supported |
| Nollie | Nollie 8 v2 / PrismRGB Prism 8 | 0x1F01 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2 as Nollie 8 v2; VID 0x16D5 is also used by PrismRGB Prism 8 |
| Nollie | Nollie 8 Youth | 0x4712 | ARGB controller | `nollie` | USB HID | — | VID 0x3061, interface 3, 8 channels x 300 LEDs |
| Nollie | Nollie L1 v1.2 | 0x1617 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 8 channels x 525 LEDs, official source maps this PID to L1 |
| Nollie | Nollie L2 v1.2 | 0x1618 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 8 channels x 525 LEDs, official source maps this PID to L2 |
| Nollie | Nollie Matrix | 0x0001 | ARGB controller | `nollie` | USB HID | — | VID 0x16D3, 1 channel x 256 LEDs |
| Nollie | Nollie TT | 0x1620 | ARGB controller | `nollie` | USB HID | — | VID 0x16D1, 2 channels x 512 LEDs, legacy 20-LED packet header |
...
| PrismRGB | Prism 8 | 0x1F01 | ARGB controller | `nollie` | USB HID | — | VID 0x16D5, PrismRGB rebrand of Nollie 8 v2, GRB byte order, 0.75 host brightness scale |
...
| Corsair | Dark Core RGB Pro SE Wireless Dongle | 0x1B7F | Other | — | Bragi receiver; child routing is not enabled yet |
| Corsair | Dark Core RGB Pro Wireless Dongle | 0x1B81 | Other | — | Bragi receiver; child routing is not enabled yet |
| Corsair | Dominator RAM | 0x1B2E | RAM | — | SMBus protocol |
| Corsair | Dominator Titanium RAM | 0x1B40 | RAM | — | — |
| Corsair | Generic Bragi Dongle | 0x1BA6 | Other | — | Bragi receiver; child routing is not enabled yet |
| Corsair | Harpoon Wireless Dongle | 0x1B65 | Other | — | Bragi receiver; child routing is not enabled yet |
| Corsair | HS80 RGB Wired | 0x0A4F | Headset | — | — |
| Corsair | Ironclaw RGB Wireless Dongle | 0x1B66 | Other | — | Bragi receiver; child routing is not enabled yet |
| Corsair | K55 | 0x1B3D | Keyboard | — | NXP/CUE zoned keyboard protocol; transport safety not enabled yet |
| Corsair | K57 Wireless Dongle | 0x1B62 | Other | — | Bragi receiver; child routing is not enabled yet |
| Corsair | K65 Legacy | 0x1B07 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| Corsair | K65 Lux RGB | 0x1B37 | Keyboard | — | NXP/CUE full-range keyboard protocol |
| Corsair | K65 RGB | 0x1B17 | Keyboard | — | NXP/CUE 512-color packed keyboard protocol |
| Corsair | K66 | 0x1B41 | Keyboard | — | NXP/CUE protocol without backlight |
| Corsair | K70 Legacy | 0x1B09 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| Corsair | K70 Lux RGB | 0x1B33 | Keyboard | — | NXP/CUE full-range keyboard protocol |
| Corsair | K70 MK.2 | 0x1B49 | Keyboard | — | NXP/CUE full-range keyboard protocol |
| Corsair | K70 RGB | 0x1B13 | Keyboard | — | NXP/CUE 512-color packed keyboard protocol |
| Corsair | K90 Legacy | 0x1B02 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| Corsair | K95 Legacy | 0x1B08 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| Corsair | K95 Platinum | 0x1B2D | Keyboard | — | NXP/CUE full-range keyboard protocol |
| Corsair | K95 RGB | 0x1B11 | Keyboard | — | NXP/CUE 512-color packed keyboard protocol |
| Corsair | M65 | 0x1B12 | Mouse | — | NXP/CUE mouse-zone RGB protocol |
| Corsair | M95 | 0x1B06 | Mouse | — | Legacy vendor-control backlight on/off |
| Corsair | Nexus LCD Companion | 0x0A44 | LCD module | — | 5-inch touchscreen, different from AIO LCDs |
| Corsair | Polaris | 0x1B3B | Mousepad | — | NXP/CUE mousepad RGB protocol |
| Corsair | Scimitar | 0x1B1E | Mouse | — | NXP/CUE mouse-zone RGB protocol |
| Corsair | ST100 | 0x0A34 | Other | — | NXP/CUE mousepad-style RGB protocol |
| Corsair | Strafe RGB | 0x1B20 | Keyboard | — | NXP/CUE full-range keyboard protocol with sidelight quirk |
...
| K60 Pro RGB Low Profile | 0x1BAD | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| K60 Pro RGB SE | 0x1B8D | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| K60 Pro TKL Black | 0x1BC7 | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| K60 Pro TKL White | 0x1BED | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| K65 Mini | 0x1BAF | Keyboard | `corsair` | USB HID | 123 | Bragi 1024-byte HID reports, per-key RGB |
| K70 Core RGB | 0x2B0A | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| K70 Core RGB | 0x1BFF | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| K70 Core RGB | 0x1BFD | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
| K70 Core RGB TKL | 0x2B01 | Keyboard | `corsair` | USB HID | 102 | Bragi 64-byte HID reports, per-key RGB |
| K70 Pro Optical | 0x1BD4 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| K70 RGB Pro | 0x1BC4 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| K70 RGB Pro V2 | 0x1BB3 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| K70 TKL | 0x1B73 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| K70 TKL Champion Optical | 0x1BB9 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
| K95 Platinum XT | 0x1B89 | Keyboard | `corsair` | USB HID | 156 | Bragi 64-byte HID reports, top-bar keyboard topology |
| Katar Pro | 0x1B93 | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
| Katar Pro V2 | 0x1BBA | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
| Katar Pro XT | 0x1BAC | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
...
| M55 RGB Pro | 0x1B70 | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
| M65 RGB Ultra Wired | 0x1B9E | Mouse | `corsair` | USB HID | 3 | Bragi 64-byte HID reports |
| M65 RGB Ultra Wireless (Wired) | 0x1BB5 | Mouse | `corsair` | USB HID | 2 | Bragi 64-byte HID reports |
...
| Dark Core RGB Pro SE Wireless Dongle | 0x1B7F | Other | — | Bragi receiver; child routing is not enabled yet |
| Dark Core RGB Pro Wireless Dongle | 0x1B81 | Other | — | Bragi receiver; child routing is not enabled yet |
| Dominator RAM | 0x1B2E | RAM | — | SMBus protocol |
| Dominator Titanium RAM | 0x1B40 | RAM | — | — |
| Generic Bragi Dongle | 0x1BA6 | Other | — | Bragi receiver; child routing is not enabled yet |
| Harpoon Wireless Dongle | 0x1B65 | Other | — | Bragi receiver; child routing is not enabled yet |
| HS80 RGB Wired | 0x0A4F | Headset | — | — |
| Ironclaw RGB Wireless Dongle | 0x1B66 | Other | — | Bragi receiver; child routing is not enabled yet |
| K55 | 0x1B3D | Keyboard | — | NXP/CUE zoned keyboard protocol; transport safety not enabled yet |
| K57 Wireless Dongle | 0x1B62 | Other | — | Bragi receiver; child routing is not enabled yet |
| K65 Legacy | 0x1B07 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| K65 Lux RGB | 0x1B37 | Keyboard | — | NXP/CUE full-range keyboard protocol |
| K65 RGB | 0x1B17 | Keyboard | — | NXP/CUE 512-color packed keyboard protocol |
| K66 | 0x1B41 | Keyboard | — | NXP/CUE protocol without backlight |
| K70 Legacy | 0x1B09 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| K70 Lux RGB | 0x1B33 | Keyboard | — | NXP/CUE full-range keyboard protocol |
| K70 MK.2 | 0x1B49 | Keyboard | — | NXP/CUE full-range keyboard protocol |
| K70 RGB | 0x1B13 | Keyboard | — | NXP/CUE 512-color packed keyboard protocol |
| K90 Legacy | 0x1B02 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| K95 Legacy | 0x1B08 | Keyboard | — | Legacy vendor-control hardware-mode lighting |
| K95 Platinum | 0x1B2D | Keyboard | — | NXP/CUE full-range keyboard protocol |
| K95 RGB | 0x1B11 | Keyboard | — | NXP/CUE 512-color packed keyboard protocol |
| M65 | 0x1B12 | Mouse | — | NXP/CUE mouse-zone RGB protocol |
| M95 | 0x1B06 | Mouse | — | Legacy vendor-control backlight on/off |
| Nexus LCD Companion | 0x0A44 | LCD module | — | 5-inch touchscreen, different from AIO LCDs |
| Polaris | 0x1B3B | Mousepad | — | NXP/CUE mousepad RGB protocol |
| Scimitar | 0x1B1E | Mouse | — | NXP/CUE mouse-zone RGB protocol |
| ST100 | 0x0A34 | Other | — | NXP/CUE mousepad-style RGB protocol |
| Strafe RGB | 0x1B20 | Keyboard | — | NXP/CUE full-range keyboard protocol with sidelight quirk |
...
> Discovered by UDP multicast on the Govee LAN protocol; LAN devices stream RGB frames directly. The Govee Developer API v1 adds cloud inventory enrichment and a control fallback for cloud-only SKUs such as bulbs. A built-in capability database maps each SKU to its LED count, segment topology, and protocol flags.

#### Supported (4)

| Device | Type | Driver | Transport | Notes |
|---|---|---|---|---|
| Govee Outdoor & String Lights | LED strip | `govee` | UDP | Outdoor string lights, curtain lights, and permanent outdoor lights with Govee LAN protocol support. |
| Govee RGBIC LED Strip | LED strip | `govee` | UDP | Per-segment RGBIC strips streamed over the Govee LAN protocol. Select SKUs (H619A, H70B1) also support Razer streaming for higher frame rates. |
...
**Devices tracked:** 13 supported · 2 researched

#### Supported (13)

| Device | PID | Type | Driver | Transport | LEDs | Notes |
|---|---|---|---|---|---|---|
| L-Wireless Controller | 0x8040 | Fan controller | `lianli` | USB bulk transfer | — | V1 2.4GHz TX (SLV3TX) paired with its 0x8041 RX sibling behind the controller's internal hub. Discovers bound TL/SL wireless fan clusters and streams per-LED RGB over RF; 26 LEDs per TL fan, up to 4 fans per cluster. |
...
| Uni Fan SL Wireless LCD | 0x1CBE:0x0005 | LCD module | `lianli` | USB bulk transfer | — | SL V3 wireless LCD receiver; same protocol as the TL receiver. |
| Uni Fan TL LCD | 0x04FC:0x7393 | LCD module | `lianli` | USB HID | — | 400x400 round panel. JPEG streaming in 512-byte packets; every unit reports serial TL_LCDV0.1, so identity keys on the USB port path. |
| Uni Fan TL Wireless LCD | 0x1CBE:0x0006 | LCD module | `lianli` | USB bulk transfer | — | One bulk receiver per wireless LCD fan over its 9-pin USB cable. 400x400 round panel; DES-wrapped 512-byte headers and a fixed 102400-byte frame write (101888 bytes of JPEG). |
...
**Devices tracked:** 19 supported

#### Supported (19)

| Device | PID | Type | Driver | Transport | Notes |
|---|---|---|---|---|---|
| Nollie 1 | 0x1F11 | ARGB controller | `nollie` | USB HID | VID 0x16D2 and NOS2 VID 0x16D5, 1 channel x 630 LEDs, GRB byte order |
| Nollie 1 CDC | 0x2A01 | ARGB controller | `nollie` | USB serial | VID 0x16D5, 115200 8N1 CDC transport |
| Nollie 16 #1 legacy / v1.2 | 0x1613 | ARGB controller | `nollie` | USB HID | VID 0x16D1 legacy 8x100 and VID 0x16D2 v1.2 channels 01-08 |
| Nollie 16 #2 legacy / v1.2 | 0x1615 | ARGB controller | `nollie` | USB HID | VID 0x16D1 legacy 8x100 and VID 0x16D2 v1.2 channels 09-16 |
| Nollie 16 v3 | 0x4716 | ARGB controller | `nollie` | USB HID | VID 0x3061 grouped Gen-2 HID; VID 0x16D5 NOS2 single-channel 1024-byte HID |
| Nollie 16 v3 NOS2 | 0x2A16 | ARGB controller | `nollie` | USB HID | VID 0x16D5 alternate PID, NOS2 single-channel 1024-byte HID |
| Nollie 2 | 0x1619 | ARGB controller | `nollie` | USB HID | VID 0x16D1, 2 channels x 512 LEDs, legacy 20-LED packet header |
| Nollie 28/12 v1.2 | 0x1616 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie 32 | 0x4714 | ARGB controller | `nollie` | USB HID | VID 0x3061 grouped Gen-2 HID; VID 0x16D5 NOS2 HID; supports ATX/GPU Strimer rows |
| Nollie 32 NOS2 | 0x2A32 | ARGB controller | `nollie` | USB HID | VID 0x16D5 alternate PID, NOS2 single-channel 1024-byte HID |
| Nollie 4 | 0x4711 | ARGB controller | `nollie` | USB HID | VID 0x3061, interface 3, 4 channels x 636 LEDs |
| Nollie 8 CDC | 0x2A08 | ARGB controller | `nollie` | USB serial | VID 0x16D5, 115200 8N1 CDC transport |
| Nollie 8 legacy / Nollie 8 v1.2 | 0x1612 | ARGB controller | `nollie` | USB HID | VID 0x16D1 legacy 8x100 and VID 0x16D2 v1.2 8x525 are both supported |
| Nollie 8 v2 / PrismRGB Prism 8 | 0x1F01 | ARGB controller | `nollie` | USB HID | VID 0x16D2 as Nollie 8 v2; VID 0x16D5 is also used by PrismRGB Prism 8 |
| Nollie 8 Youth | 0x4712 | ARGB controller | `nollie` | USB HID | VID 0x3061, interface 3, 8 channels x 300 LEDs |
| Nollie L1 v1.2 | 0x1617 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 8 channels x 525 LEDs, official source maps this PID to L1 |
| Nollie L2 v1.2 | 0x1618 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 8 channels x 525 LEDs, official source maps this PID to L2 |
...
**Devices tracked:** 3 supported

#### Supported (3)

| Device | PID | Type | Driver | Transport | Notes |
|---|---|---|---|---|---|
| Prism 8 | 0x1F01 | ARGB controller | `nollie` | USB HID | VID 0x16D5, PrismRGB rebrand of Nollie 8 v2, GRB byte order, 0.75 host brightness scale |
