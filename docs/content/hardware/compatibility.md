...
Hypercolor tracks **350 devices** across **31 vendors** in `data/drivers/vendors/`. **140** ship with a working driver today across **11 driver families**. **208 more** are researched or known, awaiting implementation or hardware to test.
