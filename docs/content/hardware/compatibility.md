...
Hypercolor tracks **338 devices** across **31 vendors** in `data/drivers/vendors/`. **128** ship with a working driver today across **11 driver families**. **208 more** are researched or known, awaiting implementation or hardware to test.
...
| Nollie | Nollie 1 | 0x1F11 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 1 channel x 630 LEDs, GRB byte order |
| Nollie | Nollie 16 v3 | 0x4716 | ARGB controller | `nollie` | USB HID | — | VID 0x3061, 16 channels x 256 LEDs, Gen-2 grouped HID protocol |
| Nollie | Nollie 28/12 | 0x1616 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie | Nollie 28/12 (rev B) | 0x1617 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie | Nollie 28/12 (rev C) | 0x1618 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie | Nollie 32 | 0x4714 | ARGB controller | `nollie` | USB HID | — | VID 0x3061, 20 main channels x 256 LEDs plus optional ATX/GPU Strimer cable rows |
| Nollie | Nollie 8 v2 | 0x1F01 | ARGB controller | `nollie` | USB HID | — | VID 0x16D2, 8 channels x 126 LEDs, GRB byte order |
...
[nolliergb.cn](https://nolliergb.cn) · VID 0x16D2, 0x3061 · Driver `nollie`

**Devices tracked:** 7 supported

#### Supported (7)

| Device | PID | Type | Driver | Transport | Notes |
|---|---|---|---|---|---|
| Nollie 1 | 0x1F11 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 1 channel x 630 LEDs, GRB byte order |
| Nollie 16 v3 | 0x4716 | ARGB controller | `nollie` | USB HID | VID 0x3061, 16 channels x 256 LEDs, Gen-2 grouped HID protocol |
| Nollie 28/12 | 0x1616 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie 28/12 (rev B) | 0x1617 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie 28/12 (rev C) | 0x1618 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 12 channels x 42 LEDs, RGB byte order |
| Nollie 32 | 0x4714 | ARGB controller | `nollie` | USB HID | VID 0x3061, 20 main channels x 256 LEDs plus optional ATX/GPU Strimer cable rows |
| Nollie 8 v2 | 0x1F01 | ARGB controller | `nollie` | USB HID | VID 0x16D2, 8 channels x 126 LEDs, GRB byte order |
