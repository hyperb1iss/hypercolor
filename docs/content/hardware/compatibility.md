...
| Corsair | K60 Pro TKL | 0x1BC7 | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
...
| Corsair | K70 Pro | 0x1BB3 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
...
| Corsair | Katar Pro | 0x1B93 | Mouse | `corsair` | USB HID | 1 | Bragi 64-byte HID reports |
| Corsair | Katar Pro XT | 0x1BAC | Mouse | `corsair` | USB HID | 1 | Bragi 64-byte HID reports |
...
**Devices tracked:** 33 supported · 34 researched
...
| K60 Pro TKL | 0x1BC7 | Keyboard | `corsair` | USB HID | 123 | Bragi 64-byte HID reports, per-key RGB |
...
| K70 Pro | 0x1BB3 | Keyboard | `corsair` | USB HID | 193 | Bragi 1024-byte HID reports, per-key RGB |
...
| Katar Pro | 0x1B93 | Mouse | `corsair` | USB HID | 1 | Bragi 64-byte HID reports |
| Katar Pro XT | 0x1BAC | Mouse | `corsair` | USB HID | 1 | Bragi 64-byte HID reports |
