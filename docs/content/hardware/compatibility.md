...
Hypercolor tracks **369 devices** across **31 vendors** in `data/drivers/vendors/`. **159** ship with a working driver today across **11 driver families**. **208 more** are researched or known, awaiting implementation or hardware to test.
...
**Devices tracked:** 33 supported · 9 researched
