...
Hypercolor tracks **415 devices** across **32 vendors** in `data/drivers/vendors/`. **180** ship with a working driver today across **12 driver families**. **233 more** are researched or known, awaiting implementation or hardware to test.
...
**Devices tracked:** 10 supported · 2 researched
