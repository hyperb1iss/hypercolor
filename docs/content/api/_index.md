...
| [MCP server](@/api/mcp.md)      | Streamable HTTP at `/mcp` | AI assistants and agents (18 tools, 5 resources, 4 prompts)      |
...
scenes, simulators, system, diagnostics, output, and the WebSocket
