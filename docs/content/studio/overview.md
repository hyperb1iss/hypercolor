...
For the full zone lifecycle (create, rename, color, enable, delete, and the Unassigned entry), see [zones](@/studio/zones.md). For moving devices between zones, see [device assignment](@/studio/device-assignment.md).
