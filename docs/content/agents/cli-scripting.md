...
- [Tools reference](@/agents/tools-reference.md): all 18 MCP tools with arguments and return shapes.
- [Prompt templates](@/agents/prompt-templates.md): the four shipped prompts agents can invoke.
