...
- The surface clients discover through it is **18 tools, 5 resources, and 4 prompts**. The [tools reference](@/agents/tools-reference.md), [resources reference](@/agents/resources-reference.md), and [prompt templates](@/agents/prompt-templates.md) are the authoritative lists.
...
- **[Tools reference](@/agents/tools-reference.md)**: The 18 tools a registry client discovers once connected.
- **[Resources reference](@/agents/resources-reference.md)**: The 5 `hypercolor://` resources, with payload shapes and freshness notes.
- **[Prompt templates](@/agents/prompt-templates.md)**: The 4 shipped prompts a connected client can surface as slash commands.
