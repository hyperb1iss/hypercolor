...
forbidden='CpuReductionExecutor|CpuExecutorSlot|MacosCpuSourceView|PreparedCpuPublicationFanout|legacy_cpu_capture_frame|native_cpu_capture_frame|publish_macos_cpu_exact|publish_macos_scalar_exact|copy_bgra8_to|with_cpu_source|new_cpu_fixture'
