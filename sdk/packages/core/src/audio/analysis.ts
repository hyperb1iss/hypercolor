...
function createSilentAudioData(): AudioData {
    return {
        bass: 0, bassEnv: 0, beat: 0, beatConfidence: 0, beatPhase: 0, beatPulse: 0,
        brightness: 0.5, chordMood: 0, chromagram: new Float32Array(PITCH_CLASSES),
        density: 0, dominantPitch: 0, dominantPitchConfidence: 0,
        frequency: new Float32Array(FFT_SIZE), frequencyRaw: new Int8Array(FFT_SIZE),
        frequencyWeighted: new Float32Array(FFT_SIZE), harmonicHue: 0,
        level: 0, levelLong: 0, levelRaw: -100, levelShort: 0,
        melBands: new Float32Array(MEL_BANDS), melBandsNormalized: new Float32Array(MEL_BANDS),
        mid: 0, midEnv: 0, momentum: 0, onset: 0, onsetPulse: 0,
        rolloff: 0.5, roughness: 0.2, spectralFlux: 0,
        spectralFluxBands: new Float32Array(3), spread: 0.3, swell: 0,
        tempo: 120, treble: 0, trebleEnv: 0, width: 0.5,
    }
}
