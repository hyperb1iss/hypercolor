    ...
    presets: [
        {
            ...
            description: 'Corporate district after curfew — cold blue towers watching through a thousand unblinking window-eyes, transit drones patrolling in silence',
            controls: {
                speed: 3,
                windowDensity: 82,
                trafficFlow: 35,
        ...
        },
        {
            ...
            description: 'The red-light blocks of a megacity — magenta haze pooling in the streets, every window a story, traffic screaming between towers',
            controls: {
                speed: 6,
                windowDensity: 95,
                trafficFlow: 88,
        ...
        },
        {
            ...
            description: 'Rolling power failure across the skyline — buildings winking out one by one, only beacons and emergency transit still burning through the dark',
            controls: {
                speed: 2,
                windowDensity: 14,
                trafficFlow: 18,
        ...
        },
        {
            ...
            description: 'A self-contained city-tower baking under twin suns — amber windows radiating heat, molten traffic arteries pumping between levels',
            controls: {
                speed: 5,
                windowDensity: 72,
                trafficFlow: 70,
        ...
        },
        {
            ...
            description: 'An alien city grown not built — organic towers pulse with aurora-green phosphorescence, transit filaments weaving through living architecture',
            controls: {
                speed: 4,
                windowDensity: 60,
                trafficFlow: 52,
